...
tf_data = tf.data  # Alias to match your code

# Point to your CIFAR-10 directory
cifar_path = r'C:\vscode\Attention_maping\cifar-10-batches-py'

# Use Keras built-in loader with custom directory
def load_cifar10_from_directory(path):
    # Set environment variable to use local files
    os.environ['KERAS_DATASETS_DIR'] = os.path.dirname(path)
    
    # Load dataset using Keras built-in function
    return keras.datasets.cifar10.load_data()

# Load dataset from your directory
(x_train, y_train), (x_test, y_test) = load_cifar10_from_directory(cifar_path)

# Split into train/validation (40k train, 10k validation)
...
import numpy as np
import os
image_path = r"C:/vscode/Attention_maping/testing/images (4).jpeg"
